...
export const createNoteSchema = z.object({
  ...
  lat: z.number().min(-90, 'Широта від -90 до 90').max(90, 'Широта від -90 до 90'),
  lng: z.number().min(-180, 'Довгота від -180 до 180').max(180, 'Довгота від -180 до 180'),
  tags: z.array(z.string()).max(10, 'Не більше 10 тегів').default([]),
})
